...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def __init__(self, config: DictConfig, role: str, **kwargs):
        ...
        # A teacher policy is forward-only and shares the same teacher-forcing
        # log-prob path as a standalone reference policy, but is kept as a
        # separate role in the trainer to avoid mixing it with KL reference use.
        self._is_ref = self.role in ["ref", "teacher", "actor_rollout_ref"]
        ...
        if self._is_actor:
            ...
            raise ValueError(
                ...
                "['actor', 'rollout', 'ref', 'teacher', 'actor_rollout', 'actor_rollout_ref']"
            )
